...
if uploaded_file is not None:
    ...
    # plot kde graphs
    sns.kdeplot(data=stroke,x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white', color=d_colours('green_3'))
    sns.kdeplot(data=not_stroke,x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white', color=d_colours('d_green'))
...
if uploaded_file is not None:
    ...
    # plot kde
    sns.kdeplot(data=m,x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white', color=d_colours('green_3'))
    sns.kdeplot(data=nm,x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white', color=d_colours('d_green'))
...
bmi_df = pd.DataFrame({'BMI':['<18.5', 'Between 18.5 & 24.9', 'Between 25 and 29.9', 'Between 30 and 39.9', '>40'], 'Classification':['Underweight','Healthy','Overweight','Obese','Severely Obese']})
...
if uploaded_file is not None:
    ...
    # plot kde graphs
    sns.kdeplot(data=stroke,x='bmi',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('green_3'))
    sns.kdeplot(data=not_stroke,x='bmi',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('d_green'))
...
link3 = '[Source](https://my.clevelandclinic.org/health/diseases/9812-diabetes-and-stroke)'
...
if uploaded_file is not None:
    ...
    # plot KDEs
    sns.kdeplot(data=stroke,x='avg_glucose_level',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('green_3'))
    sns.kdeplot(data=not_stroke,x='avg_glucose_level',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('d_green'))
...
if uploaded_file is not None:
    ...
    sns.barplot(data=df.drop(df.index[[3116]]),
    x='gender',
    y='stroke',
    hue='hypertension',
...
if uploaded_file is not None:
    ...
    sns.kdeplot(data=df[df['smoking_status']=='smokes'],x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('green_1'))
    sns.kdeplot(data=df[df['smoking_status']=='formerly smoked'],x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('green_3'))
    sns.kdeplot(data=df[df['smoking_status']=='never smoked'],x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('d_green'))
    sns.kdeplot(data=df[df['smoking_status']=='Unknown'],x='age',fill=True,alpha=0.8,linewidth=0.7, ec='white',color=d_colours('green_2'))
...
df_smoke = pd.DataFrame({'Smoking Status': ['Unknown','never smoked','smokes','formely smoked'],

'Mean Age': [df[df['smoking_status']=='Unknown']['age'].mean(),
...
'Median Age':[df[df['smoking_status']=='Unknown']['age'].median(),
